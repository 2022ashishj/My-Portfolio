...
const Home = () => {
  ...
  const handleResumeClick = (e) => {
    e.preventDefault();
    const viewUrl = 'https://drive.google.com/file/d/1Y-YY6t77i1jUrC4lgMHuHPzxNxiEGSu5/view?usp=sharing';
    const downloadUrl = 'https://drive.google.com/uc?export=download&id=1Y-YY6t77i1jUrC4lgMHuHPzxNxiEGSu5';
  ...
  const socialIcons = [
    { icon: FaGithub, link: 'https://github.com/2022ashishj', label: 'GitHub' },
    { icon: FaLinkedin, link: 'https://www.linkedin.com/in/ashish-jadhav-817363270/', label: 'LinkedIn' },
    { icon: FaEnvelope, link: 'mailto:2022ashishjadhav@gmail.com', label: 'Email' },
  ];
