...
const Navbar = () => {
  ...
  const handleResumeClick = (e) => {
    e.preventDefault();
    const viewUrl =
    'https://drive.google.com/file/d/1Y-YY6t77i1jUrC4lgMHuHPzxNxiEGSu5/view?usp=sharing';
    const downloadUrl =
      'https://drive.google.com/uc?export=download&id=1Y-YY6t77i1jUrC4lgMHuHPzxNxiEGSu5';
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: colorMode === 'light' ? 'black' : 'white', fontSize: '2rem' }}>A</span>
        <span style={{ color: colorMode === 'light' ? 'black' : 'white', fontSize: '3xl' }}>sh</span>
        <span style={{ color: 'red', fontSize: '' }}>ishJadhav</span>
      </ChakraLink>
    </Box>
      </Flex>
